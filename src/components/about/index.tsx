...
const columnData = {
    concept: ['Creative Strategy', 'Branding', 'Innovative digital concept', 'Copywrighting', 'Tone of voice'],
    design: ['Art direction', 'User experience design', 'User interface & interactive', 'design', 'Illustration', 'Motion design', '2D & 3D animation', 'Photo & video', 'Sound design'],
    tech: ['Creative development', 'Front-end development', 'Back-end development', 'App development', 'VR & AR development'],
    recognitions: ['Awwwards x 1 Studio of the Year', 'Awwwards x 1 Site of the Year', 'Awwwards x 1 Developer of the Year', 'Awwwards x 6 Site of the Month', 'Awwwards x 23 Site of the Day', 'CSSDA x 1 Corporate site of the Year', 'FWA x 1 Site of the Month', 'FWA x 2 Cuting edge awards', 'FWA x 30 Site of the Day', 'Webby Awards Best visual design x 1', 'Lovie Awards x 3']
}
        ...
        <AboutSection>
            ...
            <Container>
                ...
                <FlexDisplay className="_classExtern _itemHasMargin" justify="space-between" addStyle={{ marginTop: '140px' }}>
                    <List titleProps="Concept" lists={columnData.concept} />
                    <List titleProps="Design" lists={columnData.design} />
                    <List titleProps="Technology" lists={columnData.tech} />
                </FlexDisplay>
                <ContentDesc>
                    Immersive Garden has detailed and phased a process allowing to work hand in hand with our clients from the brief to the launch. We become one team working together on the same goal: creating a successful project. This attitude has been leading us to work with marvellous clients such as: Chanel, Nissan, Total, Redbull, Richemont, Decathlon, Adidas, Arte, Rainforest foods, Engie, Vente-privée, Orange, Google and more... We are driven by the ambitious of a project rather than its scale. We believe that good ideas can grow anywhere.
                </ContentDesc>
                <WrappedContent>
                    <ListTitle title="Recognitions" />
                    <FlexDisplay className="_classExtern" justify="space-between">
                        <List lists={columnData.recognitions.slice(0, 6)} />
                        <List lists={columnData.recognitions.slice(6, 11)} />
                    </FlexDisplay>
                </WrappedContent>
            </Container>
            <Newsletter>
